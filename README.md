...
> **Note**: This is a public CI/CD repository. The source code and build scripts are stored in a private repository and are automatically fetched during the build process.
...
The actual source code, build scripts, and resources are fetched from a private repository during the GitHub Actions workflow execution. This architecture allows us to:
- Keep the build process transparent and public
- Maintain source code privacy when needed
- Leverage GitHub Actions for automated builds and releases
