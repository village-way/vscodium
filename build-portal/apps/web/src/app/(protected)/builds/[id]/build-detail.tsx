...
const specLabels: Record<string, string> = { kind: "构建类型", version: "版本", timePatch: "time patch", platform: "平台", deliveryProfile: "交付配置（Delivery Profile）", bundleCodexRuntime: "打包 Codex runtime", outputMode: "输出类型", triggerOnly: "仅触发工作流", syncGitLab: "同步 GitLab Release", publish: "正式发布" };
const sourceRefKeys = new Set(["sourceBranch", "zhanluCoreRef", "zhanluVsRef"]);
