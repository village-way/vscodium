...
const spec = buildSpecSchema.parse({ kind: "development", version: "1.4.2", platform: "all", sourceBranch: "feature/x", zhanluCoreRef: "develop", zhanluVsRef: "refs/tags/v1", outputMode: "workflow-artifact" });
